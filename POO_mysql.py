...
class Aplicacion():
    ...
    def CHECAR(self):
        if self.combo.get()=="Informacion":
            ...
            self.boton01=tk.Button(self.frame,text="CHECAR",command=self.MASCHECAR2,bd=5)
            self.boton01.place(x=30,y=160,width=140,height=30)
            self.ventana.mainloop()
    ...
    def MASCHECAR2(self):
        if self.combo2.get()=="Nombre":
            ...
            self.boton11=tk.Button(self.frame4,text="BUSCAR",command=self.BUSCARNOM2,bd=5)
            ...
            self.boton11=tk.Button(self.frame4,text="BUSCAR",command=self.BUSCARAPE2,bd=5)
            self.boton11.place(x=40,y=130,width=120,height=30)
            self.ventana5.mainloop()
            ...
            self.boton11=tk.Button(self.frame4,text="BUSCAR",command=self.BUSCARDOMI2,bd=5)
            self.boton11.place(x=40,y=130,width=120,height=30)
            self.ventana5.mainloop()
    ...
    def BUSCARNOM2(self):
        ...
        try:
            ...
            messagebox.showinfo(message=f"No se encontraron registros\nCon estas especificaciones {nombre}",title="ERROR :)")


    def BUSCARAPE2(self):
        try:
            contador=0
            ape=self.caja000.get()
    ...
    def BUSCARDOMI2(self):
        try:
            contador=0
            dom=self.caja000.get()
    ...
    def BUSCARDOMI(self):
        try:
            with sqlite3.connect("Empleados.db") as conn:
                ...
                messagebox.showinfo(message=f"COINCIDENCIA DE REGISTROS : \n\nBuscado por : {domicilio}\nCANTIDAD DE REGISTROS ENCONTRADOS : {encontrados}",title="ENCONTRADOS POR DOMICILIO:")
